...
const STR = {
  pt: {
    ...
    foot: "AIMLottery © 2026 · Entretenimento · 18+", numb: "número", numbs: "números",
  },
  en: {
    ...
    foot: "AIMLottery © 2026 · Entertainment · 18+", numb: "number", numbs: "numbers",
  },
  es: {
    ...
    foot: "AIMLottery © 2026 · Entretenimiento · 18+", numb: "número", numbs: "números",
  },
  fr: {
    ...
    foot: "AIMLottery © 2026 · Divertissement · 18+", numb: "numéro", numbs: "numéros",
  },
  de: {
    ...
    foot: "AIMLottery © 2026 · Unterhaltung · 18+", numb: "Zahl", numbs: "Zahlen",
  },
  it: {
    ...
    foot: "AIMLottery © 2026 · Intrattenimento · 18+", numb: "numero", numbs: "numeri",
  },
};
...
function BrandMark() {
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: "0.32em", verticalAlign: "middle" }}>
      <svg width="1.5em" height="1.5em" viewBox="0 0 100 100" style={{ display: "block", flexShrink: 0 }} aria-hidden="true">
        <line x1="50" y1="5" x2="50" y2="17" stroke="#FFD700" strokeWidth="8" strokeLinecap="round" />
        <line x1="50" y1="95" x2="50" y2="83" stroke="#FFD700" strokeWidth="8" strokeLinecap="round" />
        <line x1="5" y1="50" x2="17" y2="50" stroke="#FFD700" strokeWidth="8" strokeLinecap="round" />
        <line x1="95" y1="50" x2="83" y2="50" stroke="#FFD700" strokeWidth="8" strokeLinecap="round" />
        <circle cx="50" cy="50" r="33" fill="none" stroke="#FFD700" strokeWidth="8" />
        <circle cx="50" cy="50" r="20" fill="none" stroke="#F5C518" strokeWidth="6" />
        <circle cx="50" cy="50" r="8" fill="#FFD700" />
      </svg>
      <span><span style={{ color: "#FFD700" }}>AIM</span><span style={{ color: "var(--tx0)" }}>Lottery</span></span>
    </span>
  );
}
  ...
  return (
    <div style={{ background: "var(--bg0)", borderRadius: 12, overflow: "hidden" }}>
      <div style={{ background: "var(--bg1)", borderBottom: "1px solid var(--ovB)", padding: "10px 16px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
        <div style={{ fontWeight: 800, fontSize: 18 }}><BrandMark /></div>
  ...
  return (
    <div style={{ background: "var(--bg0)", borderRadius: 12, overflow: "hidden" }}>
      <div style={{ background: "var(--bg1)", borderBottom: "1px solid var(--ovB)", padding: "10px 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ fontWeight: 800, fontSize: 17 }}><BrandMark /></div>
...
function ShareGame({ lotId, setLot }) {
  ...
  const shareText = pick ? ("🎰 AIMLottery — " + lot.nome + "\n" + (lot.flag) + " " + pick.map(pad).join(" · ") + "\n🍀 aimlottery.com") : "";
  function copiar() {
      ...
      {pick && (
        <Card>
          ...
          <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
            ...
            <button onClick={() => abrir("https://t.me/share/url?url=aimlottery.com&text=" + encodeURIComponent(shareText))} style={{ padding: "7px 14px", borderRadius: 6, border: "none", background: "#229ed9", color: "#fff", fontWeight: 700, fontSize: 12, cursor: "pointer" }}>🔵 {t("share_tg")}</button>
...
function ExportGames({ saved }) {
  ...
  function descarregar() {
    try {
      ...
      x.fillStyle = "#FFD700"; x.font = "bold 22px sans-serif"; x.fillText("AIM", 20, 36);
      x.fillStyle = "var(--tx0)"; x.fillText("Lottery", 72, 36);
      ...
      const a = document.createElement("a"); a.href = url; a.download = "aimlottery-jogos.png"; a.click();
    } catch (e) { }
  }
  return (
    <div>
    ...
    return (
      <div>
        ...
        <Card>
          ...
          <div style={{ fontSize: 13, fontWeight: 700, color: "var(--tx0)", marginBottom: 2 }}>AIMLottery {PLAN_NAMES[p.id]}</div>
...
function AppInner() {
  ...
  if (carregando) return <div style={{ background: "var(--bg0)", borderRadius: 12, padding: "60px 20px", textAlign: "center" }}><div style={{ fontWeight: 800, fontSize: 22 }}><BrandMark /></div><div style={{ marginTop: 10, fontSize: 12, color: "var(--tx1)" }}>…</div></div>;
  ...
  if (tela === "guest") return (
    <div style={{ background: "var(--bg0)", borderRadius: 12, overflow: "hidden", fontFamily: "var(--font-sans)" }}>
      <div style={{ background: "var(--bg1)", borderBottom: "1px solid var(--ovB)", padding: "8px 14px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 6 }}>
        <div style={{ fontWeight: 800, fontSize: 16 }}><BrandMark /></div>
...
export default function AIMLottery() {
